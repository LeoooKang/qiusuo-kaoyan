...
| 4.1 | 文档补丁 | ✅ 完成 | 2026-04-15 | 2026-04-15 | v26.1：修复硬编码路径 + AI 内容精修 |
...
- [x] 排除 `.obsidian/workspace.json` 出仓库
...
见 [`05-KNOWN-ISSUES.md`](./05-KNOWN-ISSUES.md) 及 [`phases/Phase-4-launch/03-PHASE-STATE.md`](./phases/Phase-4-launch/03-PHASE-STATE.md)。

主要方向：
1. **用户验证**：等待第一位学弟学妹 Fork 并在 Obsidian 中成功打开母舰
2. **Onboarding 完善**：在 `onboarding` 仓库补充图文教程
3. **内容持续精修**：对剩余 AI 味较重的笔记进行第二轮人工审校
4. **社交媒体矩阵**：通过公众号/B站/小红书发布使用教程和招募
5. **第二批舰长培养**：27 届上岸后邀请加入 `Captains` Team
